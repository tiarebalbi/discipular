...
<div class="row">
	<div class="col-lg-12">
		...
		<a type="button" href="${path}supervisor/celula/novo" class="btn btn-primary btn-lg">
			...
			<div class="col-lg-12">
				<div class="main-box clearfix">
					...
					<div class="main-box-body clearfix">
						<div class="table-responsive" data-pagina="${pagina}" data-modulo="supervisor/celula">
											...
											<td>
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<li><a href="${path}supervisor/celula/editar/${registro.id}"><i class="fa fa-pencil-square-o"></i> Editar</a></li>
														<li class="divider"></li>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<a href="${path}supervisor/celula/excluir/${registro.id}" class="btn btn-danger">Excluir</a>
															</div>
														</div>
													</div>
												</div>
