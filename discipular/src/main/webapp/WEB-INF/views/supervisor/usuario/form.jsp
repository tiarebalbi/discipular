...
<div class="row text-center">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			...
			<li><a href="${path}supervisor/lider"><i class="fa fa-users"></i> Líderes</a></li>
...
<div class="main-box">
	...
	<div class="main-box-body clearfix">
		<form:form role="form" action="${path}supervisor/lider/salvar" method="post" modelAttribute="usuario">
			...
			<div class="col-lg-12">
				...
				<a type="button" href="${path}supervisor/lider" class="btn btn-danger btn-lg pull-right">Cancelar</a> 
			</div>
		</form:form>
	</div>
</div>
