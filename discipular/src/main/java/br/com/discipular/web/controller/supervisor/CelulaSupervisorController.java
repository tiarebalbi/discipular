...
import br.com.discipular.web.editor.CustomUsuarioEditor;
import br.com.discipular.web.validator.CelulaValidator;
...
public class CelulaSupervisorController extends AbstractAdminController {
	...
	public ModelAndView apiFind(@PathVariable ("condicao") String nome) {
		...
		Page<Celula> registros = service.getRepositorio().findAll(CelulaPredicate.buscarPorNomeComFiltroCelulaAtivaEArea(nome, getCurrentUser().getArea()), CelulaPredicate.buscarPaginacao(0, QUANTIDADE_ELEMENTOS_POR_PAGINA));
